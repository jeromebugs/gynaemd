...
<title>Thank You Page | Singapore Gynaecology, Obstetrics & Aesthetic</title>
<meta name="description" content=""/>

<?php include('template-part/styles.php') ?>

<link rel="canonical" href="<?php echo lang_homepage_url() ?>thank-you.html" />
		...
		<div class="row">
			...
			<div class="col-lg-8 col-md-8 col-sm-12 col-xs-12 col-md-push-4">
					...
					<p id="breadcrumbs">You are here:
						<span xmlns:v="http://rdf.data-vocabulary.org/#">
							<span typeof="v:Breadcrumb">
								...
								<span class="breadcrumb_last">Thank You!</span>
							</span>
						</span>
					</p>
				</div>
				...
				<div class="page-content">
					...
					<p>Thank you for your kind interest in <strong>GynaeMD Women’s & Rejuvenation Clinic</strong></p>
					<p>The Contact Us form has been sent. We’ll respond to your query as soon as we can.</p>
