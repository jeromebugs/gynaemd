...
<title>Bahasa - Services| GynaeMD Women's & Rejuvenation Clinic</title>
...
<link rel="canonical" href="<?php echo lang_homepage_url('ind') ?>services.html" />

<link rel="alternate" href="<?php echo lang_homepage_url('chi') ?>services.html" hreflang="zh">
<link rel="alternate" href="<?php echo lang_homepage_url('ind') ?>services.html" hreflang="id">
	...
	<div class="container">
		<div class="row">
			...
			<div class="col-lg-8 col-md-8 col-sm-12 col-xs-12 col-md-push-4">
				...
				<!-- page-title -->
				<h1 class="page-title">DAFTAR ESTETIKA</h1>
				<!-- end .page-title -->
				...
				<div class="page-content">
				    ...
				    <p>&nbsp;</p>
				    <div class="custom-page-title">DAFTAR GINEKOLOGI</div>
				    <div class="green-border-box">
				        <p></p>
				        <ul>
				    ...
				    <p>&nbsp;</p>
				    <div class="custom-page-title">DAFTAR OBSTETRI</div>
				    <div class="green-border-box">
				        <p></p>
				        <ul>
				            <li>Klinik Pra-Kehamilan</li>
				            <li>Penilaian Risiko Antenatal</li>
				            <li>Diagnosis dan Konseling Antenatal</li>
