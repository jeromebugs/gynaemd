...
<title>欢迎你到 GynaeMD - 妇产科及美疗诊所| Services</title>
<meta name="description" content=""/>

<link rel="canonical" href="<?php echo lang_homepage_url('chi') ?>services.html" />
		...
		<div class="row">
			...
			<div class="col-lg-8 col-md-8 col-sm-12 col-xs-12 col-md-push-4">
				...
				<div class="page-content">
					...
					<p>&nbsp;</p>
					<div class="custom-page-title">妇科服务列表</div>
					<div class="green-border-box">
						<p></p>
						<ul>
							<li>一般妇科</li>
					...
					<p>&nbsp;</p>
					<div class="custom-page-title">产科服务列表</div>
					<div class="green-border-box">
						<p></p>
						<ul>
							<li>孕前检查</li>
