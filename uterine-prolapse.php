...
<title>Uterine Prolapse | GynaeMD Women's & Rejuvenation Clinic</title>
<meta name="description" content=""/>

<?php include('template-part/styles.php') ?>

<link rel="canonical" href="<?php echo lang_homepage_url() ?>uterine-prolapse.html" />

<link rel="alternate" href="<?php echo lang_homepage_url() ?>uterine-prolapse.html" hreflang="x-default">
<link rel="alternate" href="<?php echo lang_homepage_url() ?>uterine-prolapse.html" hreflang="en">
		...
		<div class="row">
			...
			<div class="col-lg-8 col-md-8 col-sm-12 col-xs-12 col-md-push-4">
					...
					<p id="breadcrumbs">You are here:
						<span xmlns:v="http://rdf.data-vocabulary.org/#">
							<span typeof="v:Breadcrumb">
								...
								<span class="breadcrumb_last">Uterine Prolapse</span>
							</span>
						</span>
					</p>
				</div>
				...
				<div class="post-main-content">
					...
					<!-- page-title -->
					<h1 class="page-title">UTERINE PROLAPSE</h1>
					<!-- end .page-title -->
					...
					<div class="author-block">
						<ul class="list-inline">
							...
							<li>·</li>
							<li>
								<div class="post-date">25/05/2015</div>
							</li>
						</ul>
					</div>
					<!-- end .author-block -->
